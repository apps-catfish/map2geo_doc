<!-- TOC -->autoauto- [これはなに](#これはなに)auto- [基本的な使い方](#基本的な使い方)auto- [ルートの転送](#ルートの転送)auto    - [ルートの転送での注意点](#ルートの転送での注意点)auto        - [経路](#経路)auto        - [経由地](#経由地)auto        - [条件](#条件)auto- [ショートカットの作成](#ショートカットの作成)auto    - [場所のショートカット](#場所のショートカット)auto    - [ルートのショートカット](#ルートのショートカット)auto    - [アプリ選択画面を開くショートカット](#アプリ選択画面を開くショートカット)auto    - [ショートカットの作成の注意点](#ショートカットの作成の注意点)auto        - [現在地の扱い](#現在地の扱い)auto- [場所/ルートの情報表示](#場所ルートの情報表示)auto- [URLインジェクターとの連携](#urlインジェクターとの連携)autoauto<!-- /TOC -->
